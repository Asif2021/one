...
export default function CustomDev() {
  return (
   <motion.div
      ...
      className="md:max-w-6xl mx-auto w-[90%] md:w-full p-4 flex mt-10 md:mt-0 flex-col bg-gradient-to-r from-cyan-50 to-gray-100 rounded-4xl md:flex-row items-center md:justify-between"
    >
      {/* Left content */}
